...
import { ArticleBlockType, ArticleType } from "entities/Article/model/const/articleConsts";
...
const ArticleDetailsPageStory: ComponentMeta<typeof ArticleDetailsPage> = {
  ...
  decorators: [
    StoreDecorator({ articleDetails: { data: article, isLoading: false, error: undefined } }),
  ],
};
